...
def assign_elf_to_toy(input_time, current_elf, current_toy, hrs):
    ...
    if unsanctioned == 0:
        return hrs.next_sanctioned_minute(start_time + duration), duration, unsanctioned
    else:
        return hrs.apply_resting_period(start_time + duration, unsanctioned), duration, unsanctioned
